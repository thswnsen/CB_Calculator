...
function InitUnitData()
{
    ...
    gradeArr.push(new UnitData(4,"브리튼 장궁수",215));
    ...
    gradeArr.push(new UnitData(3,"후스 지원 화승총수",180));
    ...
    gradeArr.push(new UnitData(3,"사막 비도 전사",180));
    ...
    gradeArr.push(new UnitData(3,"비화군",170));
