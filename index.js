...
function InitUnitData()
{
    ...
    gradeArr.push(new UnitData(5,"신정 선봉 무사",300));
    ...
    gradeArr.push(new UnitData(4,"백군 수비대",230));
    ...
    gradeArr.push(new UnitData(4,"신정 요새 기사단",220));
    ...
    gradeArr.push(new UnitData(4,"몰타 도보전 기사",215));
    ...
    gradeArr.push(new UnitData(3,"성마리아 수호자 궁수",155));
    ...
    gradeArr.push(new UnitData(3,"경기 철위영",150));
    ...
    gradeArr.push(new UnitData(3,"파발루 아카데미 의무대",90));
    ...
    gradeArr.push(new UnitData(2,"양주 표기 장군",95));
